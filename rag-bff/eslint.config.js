// ESLint flat config for the rag-bff node package (mirrors rag-api/rag-ingest).
// ESLint v9+ flat config: `@eslint/js` provides the recommended JS rules, and
// `@typescript-eslint` handles `.ts` source/test files. `no-explicit-any` is an
// error so no `any` can creep into the strict-TS backend.
