...
const stageMsTotal = computed(() => stageRows.value.reduce((acc, r) => acc + r.ms, 0));
            ...
            >
                ...
                <div class="no-scrollbar overflow-y-auto p-5">
                    <p class="m-0 mb-4 text-[12px] text-(--muted)">
                        E2E time from request to last token; below it, the per-stage breakdown
                        stacked so it should sum to E2E.
                    </p>
                    ...
                    <div class="mt-6 flex flex-wrap items-center justify-center gap-x-4 gap-y-2">
                        ...
                        >
                            <span
                                ...
                                :style="{ background: timingColor(row.label) }"
                            />
                            {{ row.label }} · {{ row.ms }}ms
                        </span>
                    </div>
