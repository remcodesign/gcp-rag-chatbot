        ...
        <div class="flex h-full min-h-0 min-w-0 flex-1 flex-col gap-4">
            <header class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-2">
                    <span
                        ...
                        :title="
                            'Vragen in dit gesprek: ' + turnCount + ' van ' + MAX_CONVERSATION_TURNS
                        "
            ...
            >
                <p class="m-0 text-[13px]">
                    Dit gesprek is afgelopen. Start een
                    <button
            ...
            >
                <div class="min-w-0">
                    ...
                    <p v-if="errorDetailText" class="m-0 mt-0.5 text-[12px] break-words opacity-80">
                        {{ errorDetailText }}
                    </p>
                </div>
                <button
                ...
                >
                    ...
                    <div class="modal-body no-scrollbar overflow-y-auto p-4 px-4.5">
                        <p class="my-0 mb-3 break-all text-[12px] text-(--muted)">
                            <span v-if="modal.score != null"
                                >score {{ formatScore(modal.score) }} ·
                            </span>
